...
export const SellProductPage = ()=>{
    ...
    return <div className=" grid grid-cols-12 gap-2">
        <div className="product md:col-span-3 col-span-12 shadow-md rounded-md px-2 py-2 border-2 border-gray-200">
            <div className="prod-img rounded-lg shadow-md mb-2 flex justify-center">
                <img src={prodData.prodColorQtyList[selectedColorIndex].prodColorImgs.mainImg.src} width={280} alt="" />
            </div>
        ...
        <div className="purchase-data md:col-span-9 col-span-12">
                    ...
                    <div className="cst-input">
                        ...
                        <div className="cst-address-inpt flex flex-col md:flex-row gap-2">
                            ...
                            <div className="city">
                                ...
                                <input type="text" className="inpt w-full" placeholder="Customer's city." value={city} onChange={e=>setCity(e.target.value)}/>
                            </div>
                        </div>
            ...
            <div className="invoice-detail flex items-center justify-between my-2 shadow-md rounded-md px-4 py-2 border-2 border-gray-200">
                ...
                <div className="invoice flex flex-col items-end">
