...
export const PageNotFound = ()=>{
    return <div className="bg-white w-screen flex flex-col items-center justify-center gap-2">
        <img className="w-56" src={notFound} alt="page not found" />
        <h1 className="text-4xl font-bold text-slate-800">Page not found buddy :/</h1>
