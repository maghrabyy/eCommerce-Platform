...
export const Modal = ({children, modalTitle,modalActions, showModal,setShowModal, onModalExit,width})=>{
    ...
    showModal && <div className='Model'>
        <div onClick={modalExitHandler} className={`modal-overlay fixed w-screen h-screen top-0 bg-black opacity-75`}></div>
        <div className={`modal-body p-4 overflow-visible fixed w-11/12 md:w-8/12 ${width?? 'xl:w-auto'} top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 rounded-lg shadow-2xl bg-gray-800 `}>
