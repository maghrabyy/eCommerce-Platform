...
export const Alert = ({showAlert,setShowAlert,alertText, alertColor})=>{
    ...
    return ReactDOM.createPortal( 
        showAlert && <div className={`alert fixed top-2 ms-2 right-2 flex items-center ${colorStyles[alertColor]} text-white py-2 pr-4 pl-3 rounded-lg font-semibold z-[100]`}>
